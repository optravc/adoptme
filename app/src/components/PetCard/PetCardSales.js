'use client';
import { Grid, Typography, Box, Card, 
...
export default function PetCardGridSales({ pets }) {
            ...
            >
              ...
              <CardContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                >
                  ...
                  <strong>ราคา:</strong> {pet.sales} บาท<br />
                  <strong>Tel:</strong> {pet.tel}<br />
                  <strong>รายละเอียด:</strong> {pet.description}<br />
                </MuiTypography>
                <Box mt={2}>
                  <Button
                    variant="contained"
